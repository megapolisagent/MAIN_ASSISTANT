...
**Research evidence:** при утверждениях о продуктах, технологиях и рынке не выдавать vendor claims, inference или отсутствие найденных решений за проверенный факт. Если сила вывода превышает доказательную базу — явно ослабить формулировку или обозначить неопределённость.
